  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        //botao flutuante no canto direito abaixo
        floatingActionButton: FloatingActionButton(
          backgroundColor: Colors.green, //alterar cot do botâo
          child: Icon(Icons.add), //icone do botâo
          onPressed: () {}, //ação quando clicar
        ),

        // ---- barra de navegação inferior
        //BottomNavigationBarItem - é item da barra de navegação
